...
class _ModeratorLoginDialogState extends State<ModeratorLoginDialog> {
  ...
  Future<void> _handleSearch() async {
    ...
    try {
      ...
      _showError(errorMessage.contains('not found') || errorMessage.contains('Invalid')
      ...
      builder: (context) => Dialog(
        ...
        child: Container(
          decoration: BoxDecoration(
            ...
            boxShadow: [
              BoxShadow(color: FrutiaColors.primary.withOpacity(0.2), blurRadius: 16, offset: const Offset(0, 8)),
            ],
          ),
          child: Column(
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        border: Border.all(color: FrutiaColors.warning.withOpacity(0.5), width: 1.5),
                      ),
                      child: Row(
                        children: [
                  ...
                  children: [
                    Expanded(
                      child: OutlinedButton(
                        ...
                        child: Text('Cancel', style: GoogleFonts.poppins(fontWeight: FontWeight.w600, color: Colors.black, fontSize: 16)),
                      ),
                    ),
                    const SizedBox(width: 12),
                    Expanded(
                      child: Container(
                        decoration: BoxDecoration(
                          borderRadius: BorderRadius.circular(12),
                          gradient: LinearGradient(colors: [FrutiaColors.primary, FrutiaColors.primary.withOpacity(0.8)]),
                          boxShadow: [BoxShadow(color: FrutiaColors.primary.withOpacity(0.4), blurRadius: 12, offset: const Offset(0, 6))],
                        ),
                        child: ElevatedButton(
                            ...
                            Navigator.push(
                              ...
                              MaterialPageRoute(
                                builder: (context) => SessionControlPanel(
                                  ...
                                  isModerator: sessionData['is_moderator'] ?? false,
                          ...
                          child: Text('Confirm', style: GoogleFonts.poppins(fontWeight: FontWeight.w700, color: Colors.white, fontSize: 16)),
                        ),
                      ),
                    ),
                  ],
  ...
  Widget _buildDetailRow(String label, String value) {
    return Row(
      ...
      children: [
        Text(label, style: GoogleFonts.lato(fontSize: 16, fontWeight: FontWeight.w500, color: Colors.black)),
        Text(value, style: GoogleFonts.lato(fontSize: 16, fontWeight: FontWeight.w600, color: Colors.black)),
      ],
    );
  }
  ...
  String _getSessionTypeName(String type) {
    switch (type) {
      case 'S': return 'MAX VARIETY';
      case 'P4': return 'TOP 4 PLAYOFFS';
      case 'P8': return 'TOP 8 PLAYOFFS';
      case 'T': return 'COMPETITIVE MAX';
      case 'O': return 'Optimized';
      default: return type;
    }
  }
                  ...
                  TextField(
                    ...
                    decoration: InputDecoration(
                      ...
                      enabledBorder: OutlineInputBorder(
                        borderRadius: BorderRadius.circular(12),
                        borderSide: BorderSide(color: FrutiaColors.primary.withOpacity(0.6), width: 2),
                      ),
                      ...
                      decoration: BoxDecoration(
                        ...
                        gradient: LinearGradient(
                          colors: _isLoading
                              ...
                              : [FrutiaColors.primary, FrutiaColors.primary.withOpacity(0.8)],
